// origin: https://github.com/jussi-kalliokoski/html5Preloader.js
/*todo: read code line by line*/
var html5Preloader = (function () {
    //generate a XHR object
    var	XHR = typeof XMLHttpRequest === 'undefined' ? function () { // IE FIX
        ...
        //if the audio elements existed return an audio object
        //todo: need to notice that there will be something wrong with my own code
        ...
        //media code dictionary for cataloging the type
    ...
    //this part is about the preload method
    ...
    html5Preloader.prototype = {
        ...
        //may be can use to find the percentage
